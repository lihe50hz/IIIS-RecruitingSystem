...
export const AdminExamInfo: React.FC = () => {
    ...
    const handleClick = () => {
        ...
        general.history.push('/Admin/ExamStudentList')
    }
    return (
        <Structure general={general}>
            ...
            <View style={[pageStyles.pageRow, { flex: 7, alignItems: 'flex-start', width: '93%' }]}>
                <Paper sx={{ overflow: 'auto', maxHeight: '100%', width: '100%',background:'rgba(255,255,255,0.75)'}}>
